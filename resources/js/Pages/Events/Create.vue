<template>
    <authenticated-layout>
        ...
        <form @submit.prevent="submitForm">
            ...
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">{{ buttonText }}</button>
        </form>
        </wrapper>
    </authenticated-layout>
</template>
    ...
    data() {
        return {
            form: {
                ...
                capacity: this.event?.capacity || 1,
            },
            buttonText: this.event ? 'Update Event' : 'Create Event',
        };
    },
    methods: {
        submitForm() {
